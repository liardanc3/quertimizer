package com.quertimizer.community.adapter.in.http;
...
class CommunityControllerIntegrationTest {
    ...
    @Autowired private CommunityPostRepositoryPort communityPostRepository;
    @Autowired private CommunityCommentRepositoryPort communityCommentRepository;
    @Autowired private CommunityPostLikeRepositoryPort communityPostLikeRepository;
    @Autowired private CommunityCommentLikeRepositoryPort communityCommentLikeRepository;
    ...
    class CreatePost {
        ...
        void successWhenRequestValid() throws Exception {
            ...
            saveUser(handle, "beginner07@example.com", UserRole.USER);
        ...
        void badRequestWhenTitleBlank() throws Exception {
            // given
            saveUser("beginner07", "beginner07@example.com", UserRole.USER);
    ...
    class UploadImage {
        ...
        void successWhenImageValid() throws Exception {
            // given
            saveUser("beginner08", "beginner08@example.com", UserRole.USER);
    ...
    class UpdatePost {
        ...
        void successWhenAuthorMatches() throws Exception {
            ...
            saveUser(handle, "beginner09@example.com", UserRole.USER);
        ...
        void forbiddenWhenAuthorDifferent() throws Exception {
            ...
            long postId = 909002L;
            String handle = "beginner09";
            saveUser("beginner10", "beginner10@example.com", UserRole.USER);
            CommunityPost post = communityPostRepository.save(CommunityPost.create(
                    postId, handle, "수정 전", "{}", "수정 전", "", "discussion", LocalDateTime.now()
            ));
    ...
    class DeletePost {
        ...
        void successWhenAuthorMatches() throws Exception {
            ...
            saveUser(handle, "advanced01@example.com", UserRole.USER);
            CommunityPost post = communityPostRepository.save(CommunityPost.create(
        ...
        void forbiddenWhenAuthorDifferent() throws Exception {
            ...
            long postId = 909004L;
            String handle = "advanced01";
            saveUser("advanced02", "advanced02@example.com", UserRole.USER);
            CommunityPost post = communityPostRepository.save(CommunityPost.create(
                    postId, handle, "삭제 대상", "{}", "삭제 대상", "", "discussion", LocalDateTime.now()
            ));
            long requestedPostId = post.getPostId();
    ...
    class TogglePostLike {
        ...
        void successWhenPostExists() throws Exception {
            ...
            saveUser(handle, "beginner05@example.com", UserRole.USER);
            savePost(postId, "liardanc3");
            SecurityMockMvcRequestPostProcessors.UserRequestPostProcessor user =
    ...
    class ToggleCommentLike {
        ...
        void successWhenCommentExists() throws Exception {
            ...
            saveUser(handle, "beginner07@example.com", UserRole.USER);
            savePost(postId, "liardanc3");
            Long commentId = communityCommentRepository.save(
                    CommunityComment.create(postId, "liardanc3", null, "댓글", LocalDateTime.now())
            ).getCommentId();
            SecurityMockMvcRequestPostProcessors.UserRequestPostProcessor user =
                    user("beginner07@example.com").roles(UserRole.USER.name());
    ...
    private CommunityPost savePost(long postId, String handle) {
        return communityPostRepository.findById(postId)
                .orElseGet(() -> communityPostRepository.save(CommunityPost.create(
                        postId, handle, "통합 테스트 게시글", validContentJson(),
                        "통합 테스트 게시글", "", "discussion", LocalDateTime.now().minusDays(1)
                )));
    }
