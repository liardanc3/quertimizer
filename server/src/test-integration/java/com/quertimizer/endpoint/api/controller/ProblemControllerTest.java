...
class ProblemControllerTest {
    ...
    void getProblemsFromStoreAndReturnBestSubmittedHistories() throws Exception {
        ...
        mockMvc.perform(get("/problems"))
                ...
                .andExpect(jsonPath("$.problems[0].submittedHistories[0].userId").value("problemuser2"))
                ...
                .andExpect(jsonPath("$.problems[0].submittedHistories[1].userId").value("problemuser1"))
                ...
                .andExpect(jsonPath("$.problems[0].submittedHistories[2].userId").value("problemuser1"))
