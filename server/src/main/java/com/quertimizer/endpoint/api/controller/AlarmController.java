...
public class AlarmController {
    ...
    public ResponseEntity<AlarmPageRes> getAlarms(@RequestParam(defaultValue = "1") int page,
        ...
        return ResponseEntity.ok(alarmService.getAlarms(currentUserId, page, pageSize));
    }
    ...
    public ResponseEntity<Void> markAllRead(Authentication authentication) {
        ...
        alarmService.markAllRead(currentUserId);
    ...
    public ResponseEntity<Void> markRead(@PathVariable Long alarmId,
        ...
        return alarmService.markRead(alarmId, currentUserId)
