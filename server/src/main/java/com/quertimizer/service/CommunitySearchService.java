...
import com.quertimizer.endpoint.api.dto.response.CommunityPostSummaryRes;
...
import com.quertimizer.search.CommunityPostDocument;
...
public class CommunitySearchService {
    ...
    private double calculateScore(CommunityPost post, List<String> tags, String normalizedSearchKeyword) {
        ...
        double authorScore = calculateTextScore(post.getUserId(), normalizedSearchKeyword, 4d);
