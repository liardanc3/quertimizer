package com.quertimizer.auth.adapter.out.email;
...
import static com.quertimizer.auth.domain.model.AuthMailContentConstant.AUTH_CODE_LABEL;
import static com.quertimizer.auth.domain.model.AuthMailContentConstant.AUTH_CODE_VALIDITY;
import static com.quertimizer.auth.domain.model.AuthMailContentConstant.AUTH_CODE_VALIDITY_HTML;
import static com.quertimizer.auth.domain.model.AuthMailContentConstant.FOOTER_NOTICE;
import static com.quertimizer.auth.domain.model.AuthMailContentConstant.IGNORE_MAIL_MESSAGE;
import static com.quertimizer.auth.domain.model.AuthMailContentConstant.VERIFICATION_LABEL;

@Component
@RequiredArgsConstructor
public class SmtpAuthMailSender implements AuthMailSenderPort {
