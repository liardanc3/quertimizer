...
public class CommunityPostLike {
    ...
    public static CommunityPostLike create(String postId, String userId) {
        return new CommunityPostLike(new CommunityPostLikeId(postId, userId), LocalDateTime.now());
    }
