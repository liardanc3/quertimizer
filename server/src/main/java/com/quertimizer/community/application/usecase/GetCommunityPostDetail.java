        ...
        return communityPostRepository.findById(input.getPostId())
                .map(post -> {
                    ...
                    return new CommunityPostDetailOutput(
                            ...
                            post.getTitle(), post.getHandle(), post.getContentJson(),
                            communityService.createImageIds(post.getImageIds()), tags, communityService.resolveCategory(post),
                            ...
                            input.getCurrentHandle() != null && input.getCurrentHandle().equals(post.getHandle()),
                            commentTree
                    );
                });
    }
