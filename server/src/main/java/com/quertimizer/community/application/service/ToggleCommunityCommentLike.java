...
public class ToggleCommunityCommentLike implements ToggleCommunityCommentLikeUseCase {
        ...
        return communityCommentRepository.findById(input.getCommentId())
                .map(comment -> {
                    ...
                    if (communityCommentLikeRepository.existsById(commentLikeId)) {
                        ...
                        return new CommunityReactionOutput(false, communityCommentRepository.save(comment).getLikeCount());
                    }
                    ...
                    communityService.publishCommentLikeAlarm(savedComment, input.getHandle());
                    return new CommunityReactionOutput(true, savedComment.getLikeCount());
                });
    }
}
