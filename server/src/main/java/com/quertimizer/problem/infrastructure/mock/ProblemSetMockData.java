...
public class ProblemSetMockData {
    ...
    public static final String TABLE_SET_00001_MYSQL_DDL = """
            CREATE TABLE customers (
                ...
                signup_date DATE NOT NULL
            ) ENGINE=InnoDB COMMENT='고객 기본 정보';
            ...
            CREATE TABLE orders (
                ...
                CONSTRAINT fk_orders_customers
                    FOREIGN KEY (customer_id) REFERENCES customers (customer_id)
            ) ENGINE=InnoDB COMMENT='주문 기본 정보';
            ...
            CREATE TABLE order_items (
                ...
                quantity INT NOT NULL CHECK (quantity > 0) COMMENT '구매 수량',
                unit_price DECIMAL(12,2) NOT NULL CHECK (unit_price >= 0) COMMENT '상품 단가',
                discount_amount DECIMAL(12,2) NOT NULL CHECK (discount_amount >= 0) COMMENT '할인 금액',
                CONSTRAINT fk_order_items_orders
                    FOREIGN KEY (order_id) REFERENCES orders (order_id)
            ) ENGINE=InnoDB COMMENT='주문 상품 정보';
            """;
    ...
    public static final String TABLE_SET_00001_MYSQL_DATA = """
            INSERT INTO customers (customer_id, customer_name, region, signup_date)
            VALUES
    ...
    public void seed() {
        ...
        problemSetRepository.save(ProblemSet.create(
                "M00001",
                TABLE_SET_00001_MYSQL_DDL,
                TABLE_SET_00001_MYSQL_DATA,
                "",
                DbmsType.MYSQL
        ));
    }
