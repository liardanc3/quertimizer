...
import com.quertimizer.problem.adapter.in.web.response.ProblemCreateRes;
...
public class ProblemController {
    ...
    public ResponseEntity<ProblemCreateRes> createProblem(@Valid @RequestBody ProblemCreateReq request) {
        ProblemCreateRes response = ProblemCreateRes.from(createProblem.execute(request.toInput()));
