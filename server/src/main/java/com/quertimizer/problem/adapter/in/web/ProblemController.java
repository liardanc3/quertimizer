...
import com.quertimizer.problem.adapter.in.web.request.ProblemCreateReq;
import com.quertimizer.problem.adapter.in.web.request.ProblemExamplePreviewReq;
import com.quertimizer.problem.adapter.in.web.request.ProblemOutputPreviewReq;
import com.quertimizer.problem.adapter.in.web.request.ProblemSearchReq;
import com.quertimizer.problem.adapter.in.web.realtime.dto.ProblemCreateProgressRes;
import com.quertimizer.problem.adapter.in.web.response.AdminProblemOptionRes;
import com.quertimizer.problem.adapter.in.web.response.ProblemDetailRes;
import com.quertimizer.problem.adapter.in.web.response.ProblemExamplePreviewRes;
import com.quertimizer.problem.adapter.in.web.response.ProblemResultPreviewRes;
import com.quertimizer.problem.adapter.in.web.response.ProblemPageRes;
import com.quertimizer.problem.adapter.in.web.response.ProblemSetDetailRes;
import com.quertimizer.problem.adapter.in.web.response.ProblemSetSummaryRes;
...
public class ProblemController {
    ...
    public ProblemController(GetProblemsUseCase getProblems, GetProblemUseCase getProblem,
                             ...
                             SessionStompSender sessionStompSender,
        ...
        this.sessionStompSender = sessionStompSender;
    ...
    private void sendProblemCreateProgress(String handle, ProblemCreateProgressRes response) {
        // 문제 생성 진행 상태 STOMP 전송 실패 시 경고 로그 기록
        try {
            sessionStompSender.sendToUser(handle, response);
        } catch (Exception exception) {
