...
@Data
@NoArgsConstructor
public class ProblemExamplePreviewReq {
    ...
    @NotBlank
    @Size(max = 100000, message = "문제 DDL은 최대 100000자까지 입력할 수 있습니다.")
    ...
    public ProblemExamplePreviewInput toInput(String requester, String clientIp) {
        return new ProblemExamplePreviewInput(
                dbms, ddl, problemDdl,
                actualDataSql, answerSql,
                requester, clientIp
        );
    }
}
