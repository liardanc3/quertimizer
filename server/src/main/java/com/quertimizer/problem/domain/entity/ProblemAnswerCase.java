...
public class ProblemAnswerCase {
    ...
    public static ProblemAnswerCase actual(String problemId, Long datasetId, String answerHash) {
        // 실제 채점 데이터 기준 정답 케이스 생성
        return new ProblemAnswerCase(null, problemId, datasetId, answerHash, ProblemAnswerCaseType.ACTUAL, 0);
    }

    public static ProblemAnswerCase hidden(String problemId, Long datasetId, String answerHash, int caseOrder) {
    ...
    public static ProblemAnswerCase restore(Long id, String problemId, Long datasetId,
    ...
    private ProblemAnswerCase(Long id, String problemId, Long datasetId,
                              String answerHash, ProblemAnswerCaseType caseType,
                              int caseOrder) {
        this.id = id;
