...
public enum ProblemCreateProgressStep {
    ...
    TABLE_INFO("table-info", 2, "테이블 정보 생성 중", "테이블 정보 생성 완료"),
    ERD_INFO("erd-info", 3, "ERD 정보 생성 중", "ERD 정보 생성 완료"),
    DATA_EXAMPLE("data-example", 4, "데이터 예시 생성 중", "데이터 예시 생성 완료"),
    OUTPUT_EXAMPLE("output-example", 5, "출력 예시 생성 중", "출력 예시 생성 완료");
