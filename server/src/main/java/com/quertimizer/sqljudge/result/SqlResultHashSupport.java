...
/**
 * Creates canonical hashes from SQL result sets.
 */
public final class SqlResultHashSupport {
    ...
    /**
     * Creates a canonical hash that preserves column and row order.
     *
    ...
    private static String sha512(String value) {
        try {
            ...
            throw new IllegalStateException("SQL result hash creation failed", exception);
        }
    }
}
