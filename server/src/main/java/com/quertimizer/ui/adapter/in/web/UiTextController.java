package com.quertimizer.ui.adapter.in.web;
...
import com.quertimizer.ui.application.port.in.GetUiTextUseCase;
...
import com.quertimizer.ui.adapter.in.web.request.UiTextSaveReq;
import com.quertimizer.ui.adapter.in.web.response.UiTextPageRes;
import com.quertimizer.ui.adapter.in.web.response.UiTextRes;
...
public class UiTextController {
    ...
    private final GetUiTextsUseCase getUiTexts;
    private final GetUiTextUseCase getUiText;
    private final GetAdminUiTextsUseCase getAdminUiTexts;
    private final CreateUiTextUseCase createUiText;
    private final UpdateUiTextUseCase updateUiText;
    private final DeleteUiTextUseCase deleteUiText;
