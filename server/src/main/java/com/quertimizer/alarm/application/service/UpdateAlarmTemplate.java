...
public class UpdateAlarmTemplate implements UpdateAlarmTemplateUseCase {
    ...
    public AlarmTemplateOutput execute(AlarmTemplateInput input) {
        ...
        return alarmTemplateService.toAlarmTemplateOutput(alarmTemplateRepository.save(alarmTemplate));
    }
}
