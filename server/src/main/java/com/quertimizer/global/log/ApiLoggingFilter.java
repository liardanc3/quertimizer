...
public class ApiLoggingFilter extends OncePerRequestFilter {
    ...
    private final LogActorResolver logActorResolver;
    ...
    private String resolveActor(HttpServletRequest request) {
        ...
        if (authentication != null && authentication.isAuthenticated() && !"anonymousUser".equals(authentication.getName())) {
            return logActorResolver.resolve(request, authentication);
        }
        ...
        if (context instanceof SecurityContext securityContext) {
            ...
            if (sessionAuthentication != null && sessionAuthentication.isAuthenticated()) {
                return logActorResolver.resolve(request, sessionAuthentication);
            }
        }

        return logActorResolver.resolve(request, null);
    }
