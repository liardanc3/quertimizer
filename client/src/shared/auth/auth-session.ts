...
import type { SessionMeResult } from '@/shared/api/auth-api';
import { applyAuthenticatedSession, clearAuthenticatedSession, syncSession, useSession } from '@/shared/auth/session';
